...
_ATTR_TOKEN = re.compile(r"(?:if|set|give|take|has|nohas|battle|join)=\S+")
...
def _parse_attrs(rest: str) -> tuple[list, dict]:
    ...
    """
    conds: list = []
    ops: dict = {"set": [], "give": [], "take": [], "has": [], "nohas": [], "battle": "", "join": []}
...
_OP_KEYS = ("set", "give", "take", "has", "nohas", "battle", "join")
